...
The `form` prompt collects multiple fields in a single view. If you need to sequentially ask users for input step-by-step, see the [Pipeline Workflow Engine](../features/pipelines.md) documentation.
